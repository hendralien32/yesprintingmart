...
<div class='id_faq' onclick="LaodForm('support',2)">
    <i class="fad fa-chevron-right"></i> Cara Buka Orderan Hanya Beli Ybanner, Roller Up, Tripod & Softboard
</div>
<div class='id_faq' onclick="LaodForm('support',6)">
    <i class="fad fa-chevron-right"></i> Cara Buka Orderan Hanya Finishing</span>
</div>
<div class='id_faq' onclick="LaodForm('support',7)">
    <i class="fad fa-chevron-right"></i> Cara Buka Orderan Hanya Laminating</span>
</div>
...
<div class='id_faq' onclick="LaodForm('support',5)">
