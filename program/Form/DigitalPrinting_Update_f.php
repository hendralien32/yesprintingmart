        ...
        <table class='table-form'>
            <tr>
                ...
                <td>
                    ...
                    <?php echo "<strong style='padding-left:10px; color:#ff7200;' class='noselect'><i class='fas fa-info-square'></i> $d[bahan] $bahan_sendiri</strong>"; ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo "<strong style='padding-left:10px; color:#ff7200;' class='noselect pointer' onclick='copy_sisa($d[qty_cetak])'><i class='fas fa-info-square'></i> " . number_format($d['Qty_Order']) . " $d[satuan] <span style='color:red'>( - " . number_format($d['abc']) . " Lembar )</span></strong>"; ?>
                </td>
            </tr>
            <tr>
