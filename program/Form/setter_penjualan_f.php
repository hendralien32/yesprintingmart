    ...
    <div class="row">
        <div class="col-6">
            <table class='table-form'>
                ...
                <tr>
                    ...
                    <td colspan="3"><?= $row['laminating']; ?></td>
                </tr>
                <?php
                ...
                ?>
                    <tr>
                        <td style='width:150px'>Biaya Offset</td>
                        <td><?= "Rp. " . number_format($row['b_offset']) . ""; ?></td>
                    </tr>
                <?php
        ...
        <div class="col-6">
            <table class='table-form'>
                <tr>
                    <td>Alat Tambahan</td>
                    <td colspan="3"><?= $row['alat_tambahan']; ?></td>
                </tr>
                <tr>
                    <td>Finishing</td>
                    <?php
                ...
                <?php if ($_SESSION['level'] == "admin" || $_SESSION['level'] == "CS" || $_SESSION['level'] == "accounting") : ?>
                    <tr>
                        <td>Biaya Design</td>
                        <td><?= "Rp. " . number_format($row['b_design']) . ""; ?></td>
                    </tr>
                    <tr>
                        <td>Biaya Delivery</td>
                        <td><?= "Rp. " . number_format($row['b_delivery']) . ""; ?></td>
                    </tr>
                    <tr>
                        <td>Biaya Discounts</td>
                        <td style="color:red; font-weight:bold"><?= "Rp. " . number_format($row['discount']) . ""; ?></td>
                    </tr>
                    <tr>
                        <td>Harga Satuan</td>
    ...
    <div class="row">
        <div class="col-6">
            ...
            <table class='table-form'>
                ...
                <tr>
                    <td>Deskripsi</td>
                    <td><input type='text' id="deskripsi" autocomplete="off" class='form ld' value="<?= $row['description']; ?>"></td>
                </tr>
                <tr>
                    <td>Ukuran</td>
                    <td>
                ...
                <tr>
                    ...
                    <td><textarea id='notes' class='form ld' style="height:50px;"><?= $row['keterangan']; ?></textarea></td>
                </tr>
            </table>
        </div>
        <div class="col-6">
    ...
    <div class="row">
        <div class="col-6">
            ...
            <table class='table-form'>
                ...
                <tr>
                    <td>Deskripsi</td>
                    <td><input type='text' id="deskripsi" class='form ld' autocomplete="off"></td>
                </tr>
                <tr>
                    <td>Ukuran</td>
                    <td><input type='text' class='form' id='ukuran'> <span id="ukuran_LF"><input type='number' class='form sd' id='panjang' onkeyup="calc_meter()"> x <input type='number' class='form sd' id='lebar' onkeyup="calc_meter()"></span><span id="perhitungan_meter"></span></td>
                </tr>
                <tr>
                    <td>sisi</td>
                    <td>
