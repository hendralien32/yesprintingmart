...
<div class="left_content">
    ...
    <input type="month" value="" data-placeholder="Dari Bulan" id="dari_tanggal" onblur="SearchDate()">
    <input type="month" value="" data-placeholder="Ke Bulan" id="ke_tanggal" onblur="SearchDate()">
    SHOW Lunas
</div>
